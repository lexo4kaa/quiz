...
/**
 * The command is responsible for forwarding to page 'quizzes'
 */
public class ToTeacherQuizzesPageCommand implements ActionCommand {
    @Override
    public Router execute(HttpServletRequest request) {
        String page = ConfigurationManager.getProperty("path.page.quizzes");
