...
<div class="container-fluid">
  <div class="text-center">
    ...
    <img src="https://chart.googleapis.com/chart?cht=qr&chl=${ createdQuizId }&chld=L|0&chs=160x160"
         class="qr-code img-thumbnail img-responsive" />
    <p>
      Change size: <input style="width: 50px" type="number" min="100" max="500" step="10" value="160" onchange="changeSize(this)">
    </p>
    <form style="float: right" name="to_quizzes_page" method="POST" action="${pageContext.request.contextPath}/controller">
      ...
      <input type="submit" value="Go to my quizzes"/>
    </form>
  </div>
</div>
